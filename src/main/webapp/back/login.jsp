	...
	<div class="login_bg" style="width:960px; margin:0 auto;">
		...
		<div class="set_area clearfix">
			<div class="wrap clearfix">
				<div id="J_loginDiv">
					<form action="${pageContext.request.contextPath}/admin" onsubmit="return fun()" method="post">
						...
						<div id="J_loginCoreWrap" class="infro">
							<div class="username" id="username_div">
								<span></span> <input class="user" id="txtUsername" name="admin.m_username" type="text" placeholder="输入管理员账户"/>
							</div>
							<br /><br />

							<div class="password" id="password_div">
								<span></span> <input class="pass" id="txtPassword" name="admin.m_password" type="password" />
							</div>
							<br /> <br />
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="${pageContext.request.contextPath}/getCode" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
