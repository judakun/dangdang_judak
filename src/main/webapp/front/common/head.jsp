	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> 
				<span class="little_n">
					| <a href="${pageContext.request.contextPath}/B1/myOrder" name="mydangdang" class="head_black12a">我的当当</a> | 
		...
		<c:if test="${sessionScope.user.u_nickname!=null}">
		<b>${sessionScope.user.u_nickname}&nbsp;&nbsp;您好，欢迎光临当当网</b>
		[&nbsp;<a href="${pageContext.request.contextPath}/U1/userExit" class="b">退出</a>&nbsp;]
		</c:if>
		<c:if test="${sessionScope.user.u_nickname==null}">
			<b>${sessionScope.user.u_nickname}&nbsp;&nbsp;用户未登录</b>
