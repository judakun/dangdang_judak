			...
			<div class="enter_in">
				...
				<div class="center">
					...
					<div class="main">
						...
						<form method="post" action="${pageContext.request.contextPath}/U1/loginAction" id="ctl00">
						<span style="color:red;font-size: 21px;margin-left: 45px;">${message}</span>
							<ul>
								<li>
									<span>请输入Email地址：</span>
									<input type="text" name="user.u_email" id="txtEmail" class="textbox" />
								</li>
								<li>
									<span class="blank">密码：</span>
									<input type="password" name="user.u_password" id="txtPassword" class="textbox" />
								</li>
								<li>
