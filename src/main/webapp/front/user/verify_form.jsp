...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/U1/register_ok?user.u_id=${user.u_id}&user.u_nickname=${user.u_nickname}" method="post">
			...
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：
						<span class="red"><span id="lblEmail">${user.u_email}</span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					</div>
					...
					<div class="mess">
						...
						<input name="user.u_code" type="text" id="validatecode" class="yzm_text" />
