	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<h6>
					您刚刚生成的订单号是：<font color="red"><strong>${sessionScope.order.o_id}</strong></font>，
					金额总计<font color="red"><strong>${sessionScope.order.o_total}</strong></font>
				</h6>

				<ul>
					<li class="nobj">
						您现在可以：还有<font color="red" id="aa"><strong>5</strong></font>秒,回到首页！！！
					</li>
					<li>
